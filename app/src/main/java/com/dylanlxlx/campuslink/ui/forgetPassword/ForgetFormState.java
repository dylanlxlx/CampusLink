...
class ForgetFormState {
    ...
    ForgetFormState(@Nullable Integer usernameError, @Nullable Integer emailError, @Nullable Integer codeError, @Nullable Integer passwordError, @Nullable Integer password2Error) {
    ...
    ForgetFormState(boolean isDataValid) {

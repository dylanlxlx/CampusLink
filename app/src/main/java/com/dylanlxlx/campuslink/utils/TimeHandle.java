...
public class TimeHandle {
    ...
    public static String formatDateTimeDialog(String dateTimeStr) {
        // 解析输入的日期时间字符串
        LocalDateTime dateTime = LocalDateTime.parse(dateTimeStr, DateTimeFormatter.ISO_LOCAL_DATE_TIME);
        ...
        // 定义日期时间格式
        DateTimeFormatter timeFormatter = DateTimeFormatter.ofPattern("HH:mm");
        DateTimeFormatter dayOfWeekFormatter = DateTimeFormatter.ofPattern("EEEE HH:mm", Locale.CHINA);
        DateTimeFormatter monthDayFormatter = DateTimeFormatter.ofPattern("MM/dd HH:mm");
        DateTimeFormatter yearMonthDayFormatter = DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm");
